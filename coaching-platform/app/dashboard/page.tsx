              ...
              <div className={`col-span-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 opacity-0 ${animationStage >= 2 ? 'animate-slideInUp opacity-100' : ''}`}>
                <Card className="overflow-hidden border-none bg-gradient-to-br from-white/80 to-white/50 dark:from-gray-900/80 dark:to-gray-900/50 backdrop-blur-sm shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(36,93,102,0.15)] dark:hover:shadow-[0_8px_30px_rgba(36,93,102,0.2)] transition-all duration-300 group transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
                  ...
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative">
                    ...
                    <CardTitle className="text-sm font-medium flex flex-col">
                      <span className="text-muted-foreground text-xs">1:1 Sessions</span>
                  ...
                  <CardContent>
                    <div className="pt-2 relative">
                      <div className="flex justify-between items-center mb-1">
                        <p className="text-xs text-muted-foreground">Total 1:1 coaching sessions</p>
                      ...
                      <div className="w-full h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                        <div className="h-full bg-primary/30 rounded-full" style={{ width: '65%' }}></div>
                      </div>
                ...
                <Card className="overflow-hidden border-none bg-gradient-to-br from-white/80 to-white/50 dark:from-gray-900/80 dark:to-gray-900/50 backdrop-blur-sm shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(36,93,102,0.15)] dark:hover:shadow-[0_8px_30px_rgba(36,93,102,0.2)] transition-all duration-300 group transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
                  ...
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative">
                    <div className="absolute top-1 right-1 w-24 h-24 bg-primary/5 rounded-full blur-2xl -z-10"></div>
                    <CardTitle className="text-sm font-medium flex flex-col">
                      <span className="text-muted-foreground text-xs">AI Sessions</span>
                      <span className="text-xl mt-1">5</span>
                    </CardTitle>
                    <div className="h-12 w-12 rounded-full flex items-center justify-center bg-gradient-to-br from-primary/10 to-primary/5 group-hover:from-primary/15 group-hover:to-primary/10 transition-all duration-300">
                      <MessageSquare className="h-5 w-5 text-primary group-hover:text-primary-light transition-colors duration-300 group-hover:scale-110 transform" />
                    </div>
                  </CardHeader>
                  <CardContent>
                    <div className="pt-2 relative">
                      <div className="flex justify-between items-center mb-1">
                        <p className="text-xs text-muted-foreground">Total AI coaching sessions</p>
                        <div className="bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-xs px-2 py-0.5 rounded-full font-medium">
                          +5
                        </div>
                      </div>
                      <div className="w-full h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                        <div className="h-full bg-primary/30 rounded-full" style={{ width: '40%' }}></div>
                      </div>
                      <div className="absolute -right-3 -bottom-3 h-16 w-16 bg-primary/5 rounded-full blur-xl -z-10"></div>
                    </div>
                  </CardContent>
                ...
                <Card className="overflow-hidden border-none bg-gradient-to-br from-white/80 to-white/50 dark:from-gray-900/80 dark:to-gray-900/50 backdrop-blur-sm shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(36,93,102,0.15)] dark:hover:shadow-[0_8px_30px_rgba(36,93,102,0.2)] transition-all duration-300 group transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
                  ...
                  <CardContent>
                    <div className="pt-2 relative">
                      <div className="flex justify-between items-center mb-1">
                        <p className="text-xs text-muted-foreground">Total resources accessed</p>
                        <div className="bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-xs px-2 py-0.5 rounded-full font-medium">
                          +7
                        </div>
                      </div>
                      <div className="w-full h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                        <div className="h-full bg-primary/30 rounded-full" style={{ width: '75%' }}></div>
                      </div>
                      <div className="absolute -right-3 -bottom-3 h-16 w-16 bg-primary/5 rounded-full blur-xl -z-10"></div>
                    </div>
                  </CardContent>
              ...
              <Card className={`col-span-4 overflow-hidden border-none bg-gradient-to-br from-white/80 to-white/50 dark:from-gray-900/80 dark:to-gray-900/50 backdrop-blur-sm shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(36,93,102,0.15)] dark:hover:shadow-[0_8px_30px_rgba(36,93,102,0.2)] transition-all duration-300 group transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none opacity-0 ${animationStage >= 5 ? 'animate-slideInUp opacity-100' : ''}`}>
                ...
                <CardContent className="relative z-10">
                  <div className="mb-4">
                    ...
                    <p className="text-muted-foreground text-sm">Select a consultant to start your free coaching session</p>
                  </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow duration-300">
                      <div className="p-4">
                        <div className="aspect-[4/3] relative mb-3 bg-gray-50 dark:bg-gray-700 rounded-md overflow-hidden">
                          ...
                          />
                          <button className="absolute bottom-3 right-3 h-10 w-10 rounded-full bg-primary text-white flex items-center justify-center shadow-lg hover:bg-primary/90 transition-colors">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground mt-1">00:00/00:14</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow duration-300">
                      <div className="p-4">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground mt-1">00:00/00:12</div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-6 flex justify-center">
                    <Button className="bg-gradient-to-r from-primary to-purple-500 hover:from-primary/90 hover:to-purple-600 text-white shadow-md hover:shadow-lg transition-all duration-300 group">
