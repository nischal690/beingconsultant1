        ...
        <>
          ...
          <div className="flex justify-between items-center mb-6 backdrop-blur-sm bg-white/5 p-4 rounded-xl border border-white/10 shadow-lg relative overflow-hidden group">
            ...
            <Button 
              ...
              variant="outline" 
              className={cn(
                "border-white/10 text-white hover:bg-white/5 hover:border-white/20 transition-all duration-300 backdrop-blur-sm relative z-10",
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 space-y-6">
                ...
                {/* Referral Card */}
                <Card className="border-white/10 bg-black/60 shadow-xl backdrop-blur-md rounded-xl hover:shadow-white/5 transition-all duration-300 overflow-hidden relative group">
                  {/* Animated background elements */}
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-500/20 to-pink-500/20 blur-2xl rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-110 transition-transform duration-700"></div>
                  <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-amber-500/10 to-amber-300/10 blur-xl rounded-full translate-y-1/2 -translate-x-1/3 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                  
                  <CardHeader className="pb-3 relative">
                    <CardTitle className="text-lg font-medium flex items-center gap-2">
                      <Gift className="h-5 w-5 text-pink-400" />
                      <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">Referral Program</span>
                    </CardTitle>
                    <CardDescription className="text-white/70">
                      Share your code and earn 10% when your referrals purchase
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 relative">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-4 bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-lg border border-white/10 flex flex-col items-center relative overflow-hidden group/code">
                        {/* Subtle animated light effect */}
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/5 via-transparent to-pink-500/5 opacity-0 group-hover/code:opacity-100 transition-opacity duration-700"></div>
                        
                        <p className="text-sm text-white/70 mb-2 relative z-10">Your Referral Code</p>
                        <div className="flex items-center justify-center w-full relative z-10">
                          <div className="px-6 py-3 bg-black/40 rounded-l-lg border border-white/10 font-mono text-xl tracking-wider text-white relative overflow-hidden group/text">
                            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 opacity-0 group-hover/text:opacity-100 transition-opacity duration-500"></div>
                            <span className="relative z-10">{profileData.referralCode}</span>
                          </div>
                          <Button 
                            onClick={copyReferralCode}
                            variant="outline" 
                            size="icon" 
                            className="h-12 rounded-l-none border border-white/10 bg-white/5 hover:bg-white/10 relative overflow-hidden group/btn"
                          >
                            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500"></div>
                        ...
                        <div className="mt-4 w-full relative z-10">
                          <Button 
                            ...
                            variant="outline" 
                            className="w-full border border-white/10 bg-gradient-to-r from-purple-900/30 to-pink-900/30 hover:from-purple-900/40 hover:to-pink-900/40 text-white group/share relative overflow-hidden"
                          >
                            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10 opacity-0 group-hover/share:opacity-100 transition-opacity duration-500"></div>
                            <Share2 className="mr-2 h-4 w-4 group-hover/share:animate-pulse relative z-10" />
                            <span className="relative z-10">Share Your Code</span>
                          </Button>
                        </div>
                      </div>
                      
                      <div className="p-4 bg-white/5 rounded-lg border border-white/10 relative overflow-hidden group/how">
                        <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 to-amber-300/5 opacity-0 group-hover/how:opacity-100 transition-opacity duration-700"></div>
                        <div className="flex items-start space-x-3 relative z-10">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-white/70 mt-1">
                              When someone uses your code during checkout, you'll earn 10% of their purchase value as credit for future sessions.
                            </p>
                            <div className="mt-4 space-y-2">
                              <div className="flex items-center space-x-2">
                                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 flex items-center justify-center text-white">1</div>
                                <p className="text-sm text-white/80">Share your unique code with friends</p>
                              </div>
                              <div className="flex items-center space-x-2">
                                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 flex items-center justify-center text-white">2</div>
                                <p className="text-sm text-white/80">They use it during checkout</p>
                              </div>
                              <div className="flex items-center space-x-2">
                                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 flex items-center justify-center text-white">3</div>
                                <p className="text-sm text-white/80">You earn 10% of their purchase</p>
                              </div>
                            </div>
                          </div>
                        </div>
