      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b shadow-sm">
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 mt-8">
            <Button 
              size="lg" 
              className="gap-2 bg-gradient-to-r from-primary/90 to-primary hover:from-primary hover:to-primary/90 transition-all duration-300 hover:shadow-md animate-in slide-up"
            >
            ...
            <Button
              ...
              className="h-10 w-10 transition-all duration-300 hover:bg-primary/10 hover:border-primary/30 animate-in slide-up"
              style={{ animationDelay: '50ms' }}
            >
              <Bookmark className={cn("h-5 w-5 transition-all duration-300", isBookmarked ? "fill-primary text-primary" : "")} />
            </Button>
            <Button
              variant="outline"
              size="icon"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3 p-4 bg-gradient-to-r from-primary/5 to-transparent rounded-lg border border-primary/10 animate-in fade-in-50">
                ...
                {findNextUnlockedChapter() && (
                  <Button 
                    size="lg" 
                    className="mt-4 gap-2"
                    onClick={() => {
                      const nextChapter = findNextUnlockedChapter();
                      if (nextChapter) {
                        setSelectedChapter(nextChapter);
                        const section = findSectionByChapterId(course, nextChapter.id);
                  ...
                  <TabsContent value="content">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Download materials to enhance your learning experience
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        {selectedChapter.resources && selectedChapter.resources.length > 0 ? (
                          <div className="grid gap-4 md:grid-cols-2">
                            {selectedChapter.resources.map(resource => (
                              <div 
                                key={resource.id}
                                className="flex items-center p-4 rounded-lg border shadow-sm hover:shadow-md transition-all hover:border-primary/20"
                              >
                                <div className="mr-4">
                                  {resource.type === "pdf" ? (
                                    ...
                                    <div className="w-12 h-12 rounded-lg bg-green-100 flex items-center justify-center text-green-600 font-semibold">
                                      URL
                                    </div>
                                  )}
                                </div>
                                <div className="flex-1">
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    {resource.type === "pdf" ? "PDF Document" : 
                                     resource.type === "worksheet" ? "Interactive Worksheet" : 
                                     "External Resource"}
                                  </p>
                                </div>
                          ...
                          <div className="py-12 flex flex-col items-center justify-center text-center text-muted-foreground animate-in fade-in-50">
                            ...
                            <p className="max-w-md text-muted-foreground/80">
                              This chapter doesn't have any downloadable resources yet. Check back later.
                            </p>
                          </div>
                        )}
                      </CardContent>
                  ...
                  <TabsContent value="discussion">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Engage with your peers and instructors about this chapter
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="py-12 flex flex-col items-center justify-center text-center text-muted-foreground animate-in fade-in-50">
                          ...
                          <p className="max-w-md mb-6 text-muted-foreground/80">
                            Be the first to start a discussion about this chapter. Ask questions, share insights, or connect with other learners.
                          </p>
                          <Button className="bg-gradient-to-r from-primary/90 to-primary hover:from-primary hover:to-primary/90 transition-all duration-300 hover:shadow-md">
