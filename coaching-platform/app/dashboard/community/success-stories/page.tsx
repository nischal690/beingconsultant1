    ...
    <div className="space-y-12">
      ...
      <section className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {[
          ...
          <Card key={i} className="bg-card/50 border shadow-soft transition-all hover:shadow-medium dark:bg-card/30">
            <CardContent className="flex flex-col items-center justify-center p-6">
              <div className="mb-2 rounded-full bg-brand-50 p-2 dark:bg-brand-900/20">{stat.icon}</div>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Link href="/dashboard/community/all-stories" className="flex items-center text-sm text-brand hover:underline">
            View all stories
          ...
          <TabsContent value="all" className="space-y-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <Card key={i} className="overflow-hidden transition-all hover:shadow-medium animate-fade-in bg-card dark:bg-card/80" style={{animationDelay: `${i * 100}ms`}}>
                  ...
                  <CardFooter className="flex items-center justify-between border-t bg-muted/10 p-4">
                    <Badge variant="outline" className="border-none bg-muted/50 hover:bg-muted dark:bg-muted/30 dark:hover:bg-muted/50">
                      {story.increase}
                    </Badge>
      ...
      <section className="relative rounded-xl bg-muted/30 p-8 md:p-12 dark:bg-muted/10">
        <div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-brand-100 opacity-50 blur-2xl dark:bg-brand-900 dark:opacity-30" />
        <div className="absolute -bottom-6 -left-6 h-32 w-32 rounded-full bg-secondary/20 opacity-50 blur-3xl dark:bg-secondary/30" />
        ...
        <div className="relative space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <Card key={i} className="bg-background border shadow-soft dark:bg-background/50">
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-2">
                    <Avatar className="h-8 w-8">
                      <AvatarFallback className="bg-brand text-white dark:bg-brand-600">
      ...
      {/* Call to Action */}
      <section className="rounded-xl bg-gradient-to-r from-brand-500 to-brand-400 p-8 text-white md:p-12 dark:from-brand-600 dark:to-brand-500">
        <div className="mx-auto max-w-[800px] text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button className="min-w-[150px] bg-white text-brand-500 hover:bg-white/90 dark:bg-white/90 dark:text-brand-600">
              Get Started Today
            </Button>
            <Button variant="outline" className="min-w-[150px] border-white/30 text-white hover:bg-white/10 dark:border-white/40 dark:hover:bg-white/20">
              Learn More
            </Button>
          </div>
        </div>
