...
export default function CommunityForum() {
  return (
    <div className="space-y-12">
      ...
      <section className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-grow">
          ...
          <Input 
            ...
            className="pl-10 border-muted bg-background/50"
          />
        </div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <Link href="#" key={i}>
              <Card className="h-full overflow-hidden transition-all hover:shadow-medium hover:border-brand/50">
                <CardHeader className="space-y-1 p-5">
                  <div className="flex items-center gap-3">
                    <div className="rounded-full bg-brand-50 p-2">{category.icon}</div>
                    <div>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          {[
            ...
            <Card key={i} className="overflow-hidden transition-all hover:shadow-soft">
      ...
      {/* Start a discussion */}
      <section className="bg-muted/20 rounded-xl p-6 border space-y-4">
        <h2 className="text-xl font-bold">Start a New Discussion</h2>
        <div className="space-y-3">
          <Input placeholder="Discussion title" className="bg-background" />
          <Textarea placeholder="Share your thoughts, questions, or insights..." className="min-h-[120px] bg-background" />
      ...
      <section className="bg-card/50 rounded-xl p-6 border space-y-4">
        <div className="flex items-center gap-3">
